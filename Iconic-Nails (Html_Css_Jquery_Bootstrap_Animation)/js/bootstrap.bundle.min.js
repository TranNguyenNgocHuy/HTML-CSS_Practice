    ...
    class qi extends W {
        constructor(t, e) {
            super(t, e),
                ...
                (this._menu =
                    z.next(this._element, Pi)[0] || z.prev(this._element, Pi)[0] || z.findOne(Pi, this._parent)),
        ...
        static dataApiKeydownHandler(t) {
            ...
            const s = this.matches(Ii)
                    ? this
                    : z.prev(this, Ii)[0] || z.next(this, Ii)[0] || z.findOne(Ii, t.delegateTarget.parentNode),
        ...
        _setListeners() {
            ...
            for (const e of t)
                if ('click' === e)
                    ...
                    const t =
                            e === ss ? this.constructor.eventName('mouseenter') : this.constructor.eventName('focusin'),
                        i =
                            e === ss
